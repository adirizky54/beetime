...
export const dateFormatEnum = pgEnum("date_format_enum", [
...
export const organizations = pgTable(
  "organizations",
  {
    ...
    dateFormat: dateFormatEnum("date_format").default("hyphen-separated-yyyy-mm-dd"),
    timeFormat: timeFormatEnum("time_format").default("24-hours"),
    intervalFormat: intervalFormatEnum("interval_format").default("hours-minutes"),
  },
