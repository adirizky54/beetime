import { RiAddLine, RiArchiveLine, RiCheckboxBlankCircleLine, RiGlobalLine, RiLock2Line, RiSearchLine } from "@remixicon/react";
...
function RouteComponent() {
  ...
  const { data: projects, isLoading: loadingProjects } = useQuery(projectQueries.list(
    orgId,
    search
  ));
  ...
  const columns = useMemo<Array<ColumnDef<Project>>>(() => [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        const publicClassName = "bg-blue-50 text-blue-700 border-blue-200 dark:bg-blue-950 dark:text-blue-300 dark:border-blue-400";
        const privateClassName = "bg-red-50 text-red-700 border-red-200 dark:bg-red-950 dark:text-red-300 dark:border-red-400";
