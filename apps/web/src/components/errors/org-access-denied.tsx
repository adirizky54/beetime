...
import { Empty, EmptyContent, EmptyDescription, EmptyHeader, EmptyMedia, EmptyTitle } from "@beetime/ui/components/empty";
          ...
          <div className="relative mx-auto w-full max-w-5xl">
            <Empty>
              ...
              <EmptyContent className="flex-row justify-center gap-2">
                <Button size="sm" render={<Link to="/" />} nativeButton={false}>Go Home</Button>
              </EmptyContent>
            </Empty>
          </div>
        </div>
