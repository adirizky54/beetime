...
import { Breadcrumb, BreadcrumbItem, BreadcrumbLink, BreadcrumbList, BreadcrumbPage, BreadcrumbSeparator } from "@beetime/ui/components/breadcrumb";
            ...
            {breadcrumbs.map((breadcrumb, index) => {
              ...
              if (!isLast) {
                return (
                  <Fragment key={index}>
                    <BreadcrumbItem>
                      <BreadcrumbLink render={<Link {...breadcrumb} />}>
                        {breadcrumb.title}
                      </BreadcrumbLink>
                    </BreadcrumbItem>
                    <BreadcrumbSeparator />
